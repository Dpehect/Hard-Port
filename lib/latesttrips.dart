...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LatestTripsPage(),
    );
  }
}

class LatestTripsPage extends StatefulWidget {
  @override
  _LatestTripsPageState createState() => _LatestTripsPageState();
}

class _LatestTripsPageState extends State<LatestTripsPage> {
...
class UpperRectangleWidget extends StatelessWidget {
  final double width;
  final double height;
  final Color color;

  UpperRectangleWidget({
    required this.width,
